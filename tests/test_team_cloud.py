...
class TeamCloudStaticUiTests(unittest.TestCase):
    ...
    def test_canvas_editors_share_workbench_visual_skin(self):
        ...
        self.assertIn("smart-canvas.js?v=2026.07.30.2", smart_html)
        ...
        self.assertIn('/static/css/agent-panel.css?v=2026.07.30.3', canvas_html)
    ...
    def test_canvas_agent_frontend_uses_agent_api_and_real_prompt_text_field(self):
        ...
        self.assertIn("/static/js/canvas-agent-panel.js?v=2026.07.30.1", smart_html)
        self.assertIn("/static/css/agent-panel.css?v=2026.07.30.2", smart_html)
